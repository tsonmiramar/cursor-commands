...
When user implies the need to inspect/validate by running commands or tests against the repo → Flag terminal/edit risk so later stages use `git worktree` isolation for evidence generation/QA
